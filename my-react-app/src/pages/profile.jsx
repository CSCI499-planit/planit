...
function PrefsEditor({ prefs, onSave, onCancel }) {
  ...
  return (
    <div className="prefs-editor">
          ...
          {[
            ...
            <label key={v} className={form.use_case === v ? 'active' : ''}>
              <input
                ...
                name="use_case"
                value={v}
                checked={form.use_case === v}
                onChange={() => set('use_case', v)}
              />
              {l}
            </label>
          ))}
          ...
          {[
            ...
            <label key={v} className={form.party_type === v ? 'active' : ''}>
              <input
                ...
                name="party_type"
                value={v}
                checked={form.party_type === v}
                onChange={() => set('party_type', v)}
              />
              {l}
            </label>
          ))}
      ...
      <fieldset>
        <legend>
          Daily Budget — {BUDGET_LABELS[form.daily_budget_tier]}
        </legend>
        ...
        <input
          ...
          min="1"
          max="5"
          value={form.daily_budget_tier || 3}
      ...
      <fieldset>
        ...
        <div className="pref-check-group">
          {INTERESTS.map(i => (
            <label
              key={i.id}
              className={form.preferred_tags?.includes(i.id) ? 'active' : ''}
            >
              <input
                type="checkbox"
                checked={form.preferred_tags?.includes(i.id)}
        ...
        <div className="pref-radio-group">
          {PACE_LABELS.map(p => (
            <label
              key={p}
              className={
                form.itinerary_pace === p.toLowerCase()
                  ? 'active'
                  : ''
              }
            >
              <input
                ...
                name="itinerary_pace"
                value={p}
                checked={form.itinerary_pace === p.toLowerCase()}
                onChange={() =>
                  set('itinerary_pace', p.toLowerCase())
                }
              />
              {p}
            </label>
    ...
    <div className="page">
      ...
      <div className="profile-container">
        ...
        <div className="profile__body">
          ...
          <div className="profile__col-stack">
